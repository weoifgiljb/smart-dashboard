...
- **番茄钟**：
  - 25/5 分钟专注节奏，前后台运行稳定；沉浸式 UI
- **单词学习**：
  - SM-2 简化算法安排复习；新增/删除/复习与趋势图；卡片翻转模式
- **任务与仪表盘**：
  - 任务清单与完成统计，Bento Grid 风格仪表盘汇总关键指标
- **我的日记**：
  - 记录每日心情与感悟，支持 Markdown 编辑与智能表情包配图
- **AI 对话**：
  - 支持流式响应、多会话管理；后端优先走 Ollama，本地不可用时回退通义千问
- **书籍推送**：
